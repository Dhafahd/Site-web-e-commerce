        ...
        <div class="container">
                                ...
                                <div class="cart-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1 my-auto">
                                            <label class="price">{{ $cartItem->product->selling_price }} MAD</label>
                                        </div>
                                        ...
                                        <div class="col-md-1 my-auto">
                                            <label class="price">{{ $cartItem->product->selling_price * $cartItem->quantity }} MAD</label>
            ...
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    {{-- <h4>
                        Check out our latest products! <a class="btn btn-primary" href="{{ url('/collections') }}">SHOP</a>
                    </h4> --}}
                </div>
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        <h4>Total:
                            <span class="float-end">{{ $totalPrice }} MAD</span>
                        </h4>
                        <hr>
